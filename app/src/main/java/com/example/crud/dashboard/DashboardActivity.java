...
public class DashboardActivity extends BaseActivity {
    ...
    private void setupData() {
        dashboardItemItems = new ArrayList<>();
        ...
        dashboardItemItems.add(dashboardItem1);
        ...
        dashboardItemItems.add(dashboardItem2);
        ...
        dashboardItemItems.add(dashboardItem3);
        ...
        dashboardItemItems.add(dashboardItem4);
    }
//Todo: Create new Method for ids in all classes give proper name
    ...
    private void setupDashboardItemsRv() {
        ...
        dashboardAdapter.setData(dashboardItemItems);
